...
namespace Cervezas.Controllers
{
    ...
    [GeneratedCode("T4MVC", "2.0"), DebuggerNonUserCode]
    public partial class T4MVC_QuestionsController : Cervezas.Controllers.QuestionsController
    {
        public T4MVC_QuestionsController() : base(Dummy.Instance) { }

        partial void IndexOverride(T4MVC_System_Web_Mvc_ActionResult callInfo, int siteId, int surveyId);

        public override System.Web.Mvc.ActionResult Index(int siteId, int surveyId)
        {
            ...
            IndexOverride(callInfo, siteId, surveyId);
            return callInfo;
        }

        partial void AddOverride(T4MVC_System_Web_Mvc_ActionResult callInfo, int siteId, int surveyId);

        public override System.Web.Mvc.ActionResult Add(int siteId, int surveyId)
        {
            var callInfo = new T4MVC_System_Web_Mvc_ActionResult(Area, Name, ActionNames.Add);
            ModelUnbinderHelpers.AddRouteValues(callInfo.RouteValueDictionary, "siteId", siteId);
            ModelUnbinderHelpers.AddRouteValues(callInfo.RouteValueDictionary, "surveyId", surveyId);
            AddOverride(callInfo, siteId, surveyId);
            return callInfo;
        }

        partial void AddOverride(T4MVC_System_Web_Mvc_ActionResult callInfo, int siteId, int surveyId, Cervezas.Models.Question question);

        public override System.Web.Mvc.ActionResult Add(int siteId, int surveyId, Cervezas.Models.Question question)
        {
            var callInfo = new T4MVC_System_Web_Mvc_ActionResult(Area, Name, ActionNames.Add);
            ModelUnbinderHelpers.AddRouteValues(callInfo.RouteValueDictionary, "siteId", siteId);
            ModelUnbinderHelpers.AddRouteValues(callInfo.RouteValueDictionary, "surveyId", surveyId);
            ModelUnbinderHelpers.AddRouteValues(callInfo.RouteValueDictionary, "question", question);
            AddOverride(callInfo, siteId, surveyId, question);
            return callInfo;
        }
